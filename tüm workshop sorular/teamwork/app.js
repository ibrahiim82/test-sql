/*
1. React kütüphanesinden yalnızca Bileşeni içe aktarmak istiyorsanız, hangi sözdizimini kullanıyorsunuz?
...
5. Props değerlerini mümkün olduğunda bir bileşenin durumuna kopyalamaktan kaçınmak neden önemlidir?
...
A. state'e (duruma) child component ekleyen bir özellik
B. bir diziyi özellik olarak ayarlamanıza izin veren bir özellik
C. child elementlere(alt öğelere) veri aktarmanıza izin veren bir özellik
D. jsx'in hem açılış etiketi hem de kapanış etiketi içeren componentlerde 
üzerinde oluşturduğu ve içeriğine atıfta bulunan özel bir özellik.          Cevap D
...
13. React'te geleneksel detch API'sine göre Axios kullanmanın birincil avantajı nedir?
...
1. Özel Hook Nelerdir?

Javascript'te adı ‘use’ ile başlayan ve diğer kancaları çağıran bir işlevdir.

Neredeyse tüm durumlarda, özel kancaların, render desteklerini ve HoC'leri (Yüksek Dereceli bileşenler) değiştirmek ve gereken iç içe geçme miktarını azaltmak için yeterli olduğu düşünülmektedir. Özel Kancalar, Render Props ve HoC'lerle birlikte gelebilecek birden fazla soyutlama katmanından veya sarmalayıcı cehenneminden kaçınmanıza olanak tanır.

Özel Hookların dezavantajı, bir ok işlevi kullanırken yapıcının içine 'bunu' bağlamanın gereksiz olduğu classes.is içinde kullanılamamasıdır. Bu, React geri aramalarında 'this' kullanımından kaynaklanan hataları önler.
